...
def create_llm_client(
    ...
    **kwargs,
    ...
    if provider_lower == "anthropic":
        from tradingagents.llm.anthropic_client import AnthropicClient
    ...
    if provider_lower == "azure":
        from tradingagents.llm.azure_client import AzureOpenAIClient
        return AzureOpenAIClient(model, base_url, **kwargs)

    if provider_lower == "bedrock":
        from tradingagents.llm.bedrock_client import BedrockClient
        return BedrockClient(model, base_url, **kwargs)

    from tradingagents.llm.openai_client import OpenAIClient, is_openai_compatible
