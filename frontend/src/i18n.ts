...
const en = {
  translation: {
    ...
    retireMethodFeedback: "Retire Method Feedback",
    retirementConfirmation:
      "This action is irreversible. It preserves the Observation, Reflection, and attempt history, and does not disable future settlement for this instrument.",
    ...
    retirementSuccess: "Method Feedback retired.",
    all: "All",
...
const zhCN = {
  translation: {
    ...
    retireFeedback: "停用反馈",
    retireMethodFeedback: "停用方法反馈",
    retirementConfirmation:
      "此操作不可撤销。它会保留结果观察、方法反思和尝试历史，也不会禁用该标的未来的结算。",
    retirementReason: "原因",
    retirementReasonOptions: {
      not_useful: "没有帮助",
      too_specific: "过于具体",
...
const ja = {
  translation: {
    ...
    retireMethodFeedback: "方法フィードバックを廃止",
    retirementConfirmation:
      "この操作は元に戻せません。結果観測、方法の振り返り、試行履歴は保持され、この銘柄の将来の決済を無効にしません。",
    retirementReason: "理由",
    retirementReasonOptions: {
      not_useful: "役に立たない",
      too_specific: "具体的すぎる",
    ...
    retirementSuccess: "方法フィードバックを廃止しました。",
    all: "すべて",
    rawReturn: "収益率",
    alphaReturn: "アルファ",
