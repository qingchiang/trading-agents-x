...
export default function Timeline() {
  ...
  return <section className="timeline-page">
    ...
    <ResearchWorkspace history={<div className="workspace-history">
      ...
      {selected && !comparisonView && <Suspense fallback={<div role="status">{t("loading")}</div>}><ResearchReader selectedRunId={selected.id} actionsTarget={actionsTarget} key={selected.id} /></Suspense>}
