...
import { legacyResearchLocation, readingViews } from "../researchLinks";
...
const LegacyReader = lazy(() => import("../components/ResearchReader").then(module => ({ default: module.ResearchReaderContent })));
