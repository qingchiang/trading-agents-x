...
import { api, type CalculationRecord, type NumericRequirementCheck, type RunDetail } from '../api/client';
import ResearchNumericAudit from './ResearchNumericAudit';
import { makeRun, result } from '../../e2e/fixtures/research';
vi.mock('../api/client', async original => ({ ...await original<typeof import('../api/client')>(), api: { run: vi.fn() } }));
