...
class NewsRenderTests(unittest.TestCase):
    ...
    def test_filters_by_securities_code(self):
        ...
        with self._patch(mapping):
            out = edinet_news.get_news("9984.T", "2026-06-22", "2026-06-22", data_context=request_context())
    ...
    def test_window_iterates_each_date_and_sorts_recent_first(self):
        ...
        with self._patch(mapping):
            out = edinet_news.get_news("9984.T", "2026-06-20", "2026-06-22", data_context=request_context())
    ...
    def test_per_date_fetch_is_memoized(self):
        ...
        with mock.patch.object(edinet_common, "fetch_documents", mock_fetch):
            edinet_news.get_news("9984.T", "2026-06-22", "2026-06-22", data_context=request_context())
            edinet_news.get_news("9984.T", "2026-06-22", "2026-06-22", data_context=request_context())
    ...
    def test_long_window_is_capped(self):
        mock_fetch = mock.Mock(side_effect=_by_date({}))
        with mock.patch.object(edinet_common, "fetch_documents", mock_fetch):
            out = edinet_news.get_news("9984.T", "2020-01-01", "2026-06-22", data_context=request_context())
        self.assertEqual(
...
class DocumentCacheTests(unittest.TestCase):
    ...
    def test_settled_date_survives_memory_clear_via_disk(self):
        ...
        with mock.patch.object(edinet_common, "tokyo_today", return_value=date(2026, 6, 23)), \
            ...
            self.assertEqual(edinet_common.documents_on("2026-06-22", data_context=request_context()), records)
    ...
    def test_today_is_memory_only_with_short_ttl(self):
        ...
        self.assertFalse(Path(edinet_common._disk_file("2026-06-22", data_context=request_context())).exists())
...
class RoutingTests(unittest.TestCase):
    ...
    def test_tokyo_ticker_routes_news_to_edinet(self):
        ...
        with mock.patch.dict(
            ...
            result = interface.route_to_vendor("get_news", "9984.T", "2026-06-20", "2026-06-22", data_context=request_context())
