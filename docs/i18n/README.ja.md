...
Python 3.12–3.14 と uv 0.12.1 以降をサポートします。Node.js は 22.12 以降の
Node 22 系をフロントエンド開発時だけ使用し、リポジトリの `.nvmrc` が対応する
メジャーバージョンを選択します。リリース wheel にはビルド済み Web assets が
含まれます。
